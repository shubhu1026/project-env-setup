...
SERVICE_NAME = app
CONTAINER_NAME = cyber-bullying-detection-template-container

DIRS_TO_VALIDATE = cyber_bullying_detection
...
## Call entrypoint
entrypoint: up
	$(DOCKER_COMPOSE_EXEC) python ./shubhu1026/entrypoint.py
